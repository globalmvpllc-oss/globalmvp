...
export const tr: Dictionary = {
  ...
  'nav.cheques': 'Çek/Senet',
  'cheques.title': 'Çek ve senetler',
  'cheques.subtitle': 'Portföyünüzdeki ve keşide ettiğiniz çek ve senetler',
  'cheques.add': 'Çek/senet ekle',
  'cheques.addTitle': 'Çek ya da senet ekle',
  'cheques.editTitle': 'Kaydı düzenle',
  'cheques.direction': 'Yön',
  'cheques.directionReceived': 'Alınan',
  'cheques.directionIssued': 'Verilen',
  'cheques.instrument': 'Kıymet türü',
  'cheques.instrumentCheque': 'Çek',
  'cheques.instrumentNote': 'Senet',
  'cheques.bankName': 'Banka',
  'cheques.bankNamePlaceholder': 'Kıymet üzerindeki banka',
  'cheques.chequeNumber': 'Numara',
  'cheques.chequeNumberPlaceholder': 'Üzerinde yazdığı gibi',
  'cheques.drawer': 'Keşideci',
  'cheques.drawerPlaceholder': 'Kimin düzenlediği',
  'cheques.dueDate': 'Vade',
  'cheques.issueDate': 'Keşide tarihi',
  'cheques.statusPortfolio': 'Portföyde',
  'cheques.statusPresented': 'Tahsile verildi',
  'cheques.statusCleared': 'Tahsil edildi',
  'cheques.statusOutstanding': 'Ödenmemiş',
  'cheques.statusPaid': 'Ödendi',
  'cheques.statusBounced': 'Karşılıksız',
  'cheques.statusCancelled': 'İptal edildi',
  'cheques.allDirections': 'Alınan ve verilen',
  'cheques.allStatuses': 'Tüm durumlar',
  'cheques.filterDirection': 'Yöne göre filtrele',
  'cheques.held': 'Portföyde',
  'cheques.heldHint': 'Henüz kapanmadı. Bu bir taahhüt, elinizdeki para değil.',
  'cheques.dueSoon': '30 gün içinde vadesi gelen',
  'cheques.bounced': 'Karşılıksız',
  'cheques.instrumentCount': '{count} kayıt',
  'cheques.empty': 'Henüz çek ya da senet yok',
  'cheques.emptyHint':
    'Bir çek ya da senet kaydedin; burada görünür ve vadesi takvime düşer.',
  'cheques.emptyFiltered': 'Bu filtrelere uyan kayıt yok',
  'cheques.emptyFilteredHint': 'Yukarıdaki yön ya da durum seçimini değiştirin.',
  'cheques.loadFailed': 'Çek ve senetleriniz yüklenemedi.',
  'cheques.notFound': 'Kayıt bulunamadı',
  'cheques.created': 'Kayıt oluşturuldu.',
  'cheques.updated': 'Kayıt güncellendi.',
  'cheques.deleted': 'Kayıt silindi.',
  'cheques.amountRequired': 'Sıfırdan büyük bir tutar zorunludur.',
  'cheques.dueDateRequired': 'Vade tarihi zorunludur.',
  'cheques.deleteTitle': 'Bu kayıt silinsin mi?',
  'cheques.deleteBody':
    'Bu işlem çek ya da senet kaydını siler. Daha önce oluşturduğu tahsilat olduğu gibi kalır.',
  'cheques.changeStatus': 'Durumu değiştir',
  'cheques.statusChanged': '{status} olarak işaretlendi.',
  'cheques.markPresented': 'Tahsile verildi işaretle',
  'cheques.markCleared': 'Tahsil edildi işaretle',
  'cheques.markPaid': 'Ödendi işaretle',
  'cheques.markBounced': 'Karşılıksız olarak kaydet',
  'cheques.markCancelled': 'Kaydı iptal et',
  'cheques.terminal': 'Bu kayıt kapandı ve artık değiştirilemez.',
  'cheques.clearConfirm':
    'Bu kayıt tahsil edildi olarak işaretlensin mi? {amount} tutarında bir tahsilat kaydedilecek; para ancak bu noktada tahsil edilmiş sayılır.',
  'cheques.paidConfirm':
    'Bu kayıt ödendi olarak işaretlensin mi? Kapattığı gidere karşılık {amount} tutarında bir ödeme kaydedilecek.',
  'cheques.bouncedConfirm':
    'Bu kayıt karşılıksız olarak kaydedilsin mi? Kayıt karşılıksız olarak defterde kalır ve hiçbir para hareketi oluşmaz.',
  'cheques.settledNote': '{date} tarihinde tahsil edildi — {amount} tutarında tahsilat kaydedildi.',
  'cheques.notMoneyYet':
    'Portföydeki kıymetler taahhüttür, para değil. Tahsil edilene kadar hiçbiri gelire, alacaklara ya da fatura bakiyesine sayılmaz.',
